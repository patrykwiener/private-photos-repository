...
class ImageSharedListBase(ImagePostListBase, metaclass=abc.ABCMeta):
    ...
    def __init__(self):
        super(ImageSharedListBase, self).__init__()
        self.shared_images = {}

    def get(self, request, *args, **kwargs):
        super_get_result = super(ImageSharedListBase, self).get(request, *args, **kwargs)
    ...
    def get_context_data(self, **kwargs):
        context = super(ImageSharedListBase, self).get_context_data(**kwargs)
